...
This repository is a standalone miner variant prepared for production rollout with the gen20_tens1_7k_vote101_hardened TorchScript scorer, prod-like runtime preprocessing, and a strict decision threshold of 1.0.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-ml20tens3.git
cd poker44-miner-ml20tens3
python3 -m venv .venv
...
Base release lineage: ml20tens3 with the gen20_tens1_7k_vote101_hardened artifact and decision threshold fixed at 1.0.
